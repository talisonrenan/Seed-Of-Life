...
if (instance_exists(target_object)) {
    ...
    if (target_object.object_index == obj_cogumelo1 || 
        target_object.object_index == obj_cogumelo2 || 
        target_object.object_index == obj_cogumelo3) {
        ...
        if (variable_instance_exists(target_object, "hp")) {
            ...
            if (target_object.hp <= 0) {
                ...
                // Esconde barra de vida da Cogumelo
