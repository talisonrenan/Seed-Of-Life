...
var tree1_inst  = instance_nearest(x, y, obj_cogumelo1);
var tree2_inst  = instance_nearest(x, y, obj_cogumelo2);
var tree3_inst  = instance_nearest(x, y, obj_cogumelo3);
...
// Cogumelo 1
var tree1_count = instance_number(obj_cogumelo1);
for (var i = 0; i < tree1_count; i++) {
    var tree = instance_find(obj_cogumelo1, i);
    if (tree.hp > 0) {
...
if (all_trees_destroyed) {
    var tree2_count = instance_number(obj_cogumelo2);
    for (var i = 0; i < tree2_count; i++) {
        var tree = instance_find(obj_cogumelo2, i);
        if (tree.hp > 0) {
            all_trees_destroyed = false;
            break;
        }
